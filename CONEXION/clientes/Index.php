...
<div class="modal fade" id ="ModalNuevo">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header"> <h4 class="modal-tittle">Clientes | Nuevo Registro</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" class="form-control" placeholder="Fecha Nacimiento">
                                </div>
                            </div> 
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="apMaterno">Teléfono:</label>
...
<script type="text/javascript" src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
  ...
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
   ...
   if(nombre == ""|| ap_paterno== "" || ap_materno =="" || correo == "" || direccion ==""||
   fecha_nacimiento == "" || telefono =="" || sexo == "" || curp =="" || codigo_postal ==""){
Swal.fire({
    ...
    success:function(response){
      ...
      if (age < 18) {
        Swal.fire({
          icon: "error",
          title: "Lo siento.",
          text: "Fecha de nacimieto no valida. El cliente debe ser mayor a 18 años.",
          footer: '<a href="#"></a>'
        });
        $("#fecha_nacimiento").val("");
      }
